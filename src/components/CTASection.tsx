      ...
      <div className="container">
        <div className="bg-brand-blue rounded-2xl text-white p-8 md:p-12 relative overflow-hidden">
          ...
          <div className="relative z-10 max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl mb-8 text-blue-100">Join thousands of business leaders who use Spyer to stay ahead of market changes, track competitors, and make data-driven decisions.</p>
